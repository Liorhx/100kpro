        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-4 group text-left">
            ...
            <div className="flex flex-col -space-y-1">
              <span className="font-sans font-black tracking-widest text-xl uppercase leading-none italic text-zinc-400">
                100K<span className="text-zinc-800">PRO</span>
              </span>
              <span className="text-[7px] font-mono font-black text-zinc-800 uppercase tracking-[0.4em]">
                Automated_Growth_Protocol
              </span>
            </div>
          </div>
          <p className="text-[9px] font-mono font-black text-zinc-700 uppercase tracking-[0.2em] leading-loose max-w-xs text-left">
            // This system is designed for high-performance content creators.
            Unauthorized duplication is strictly prohibited.
          </p>
        </div>

        <div className="flex flex-col md:items-end gap-6 w-full md:w-auto">
          <span className="text-[8px] font-mono font-black text-zinc-500 uppercase tracking-[0.5em] italic">
            Get_In_Touch
          </span>
          <a
          ...
          >
            <div className="flex flex-col items-start md:items-end -space-y-0.5">
              <span className="text-[8px] font-mono font-black text-amber uppercase tracking-[0.4em] mb-1">
                Technical_Support
              </span>
              <span className="text-sm md:text-lg font-black tracking-tight text-white group-hover:text-amber transition-colors">
