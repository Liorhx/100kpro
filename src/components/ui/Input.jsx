  ...
  return (
    <div className="space-y-1.5 w-full text-left">
      <div className="flex justify-between items-end ml-1">
        <label className="text-[9px] uppercase tracking-[0.3em] font-mono font-black text-zinc-600">
          {label}
        </label>
        {error && (
      ...
      <div className="relative group">
        <div
          className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${error ? "text-red-500" : success ? "text-emerald-500" : "text-zinc-700 group-focus-within:text-amber"}`}
        >
          <Icon size={12} />
        </div>
        <input
