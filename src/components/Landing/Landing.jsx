...
// Use a high-quality YouTube/Content creator themed placeholder
...
const ProcessSection = () => {
  const steps = [
    {
      title: "Find Unlimited High performing ideas",
      desc: "Identify content formats that are already getting massive views.",
    },
    {
      title: "Easy Way To Write Your Script",
      desc: "Convert ideas into short, engaging scripts in minutes.",
    },
    {
      title: "Enhance With Smart Tools",
      desc: "Refine your script for better hooks, clarity, and retention.",
    },
    {
      title: "Generate Free Unlimited AI Voiceovers",
      desc: "Create high-quality audio without recording your own voice.",
    },
    {
      title: "Edit for Engagement",
      desc: "Add subtitles, pacing, and visual flow to keep viewers watching.",
    },
    {
      title: "Upload With Strategy",
      desc: "Use the right titles, sounds, and timing to boost reach.",
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-10 text-left">
        <div className="mb-10 md:mb-20 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[8px] font-mono font-black uppercase tracking-[0.5em] text-amber italic">
              The Plan
            </span>
          </div>
...
const ResultsSection = () => {
  return (
    <section className="py-10 md:py-24 border-b border-zinc-900 bg-[#0A0A0A] overflow-hidden relative">
      {/* Background grid effect */}
      <div
        className="absolute inset-0 opacity-[0.03] pointer-events-none"
        style={{
          backgroundImage: "radial-gradient(#amber 1px, transparent 0)",
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-10 relative z-10">
        <div className="text-center mb-12 md:mb-20">
          <h2 className="heading-tactical text-3xl md:text-8xl leading-none text-white inline-block relative">
            REAL <span className="text-zinc-800">RESULTS.</span>
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-24 h-[2px] bg-amber"></div>
          </h2>
        </div>

        <div className="flex justify-center relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-full max-h-[400px] ambient-glow scale-150 pointer-events-none opacity-20 blur-[120px]"></div>

          <div className="relative z-10 w-full max-w-[340px] md:max-w-5xl mx-auto">
            <motion.div
            ...
            >
              {/* Decorative corners */}
              <div className="absolute -top-4 -left-4 w-8 h-8 border-t-2 border-l-2 border-amber/30"></div>
              <div className="absolute -bottom-4 -right-4 w-8 h-8 border-b-2 border-r-2 border-amber/30"></div>

              <div className="relative overflow-hidden rounded-2xl border border-white/5 bg-zinc-900/40 backdrop-blur-md shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] via-transparent to-white/5 z-20"></div>

                <img
                  src={proofImg}
                  alt="Channel Growth Proof"
                  className="w-full h-auto relative z-10 transition-all duration-1000 group-hover:scale-105 saturate-[0.8] brightness-[0.9] contrast-[1.1] hover:saturate-100 hover:brightness-100"
                  style={{
                    maskImage:
                ...
                {/* Cinematic flare */}
                <div className="absolute -top-1/4 -right-1/4 w-1/2 h-1/2 bg-amber/10 blur-[100px] rounded-full z-20 pointer-events-none"></div>

                {/* Scanning line effect */}
                <div className="absolute inset-0 pointer-events-none z-30 opacity-20">
                  <div className="w-full h-[1px] bg-amber animate-scanline"></div>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mt-16 flex flex-col items-center space-y-4">
          <p className="text-center text-zinc-500 font-mono font-bold text-[10px] uppercase tracking-[0.3em] max-w-xl mx-auto px-4 italic">
            // AUTHENTICATED CHANNEL GROWTH METRICS //
          </p>
          <div className="flex gap-4">
            <div className="flex items-center gap-2 px-3 py-1 border border-amber/20 bg-amber/5 rounded-full">
              <div className="w-1.5 h-1.5 rounded-full bg-amber animate-pulse"></div>
              <span className="text-[10px] font-mono text-amber uppercase font-black tracking-wider">
                Verified State
              </span>
            </div>
          </div>
...
const FomoSection = ({ onAction }) => {
  ...
  useEffect(() => {
    ...
    const seatTimer = setInterval(() => {
      setSeatsLeft((prev) =>
        prev > 2 ? prev - (Math.random() > 0.9 ? 1 : 0) : 2,
      );
    }, 15000);
    return () => {
      clearInterval(timer);
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          <div className="space-y-6 md:space-y-8">
            <div className="inline-flex items-center gap-3 px-3 py-1.5 border border-red-900/30 bg-red-950/10">
              ...
              <span className="text-[9px] font-mono font-black uppercase tracking-[0.3em] text-red-500">
                Offer Ending Soon
              </span>
            </div>
            ...
            <div className="space-y-6 text-zinc-500 font-mono font-bold leading-relaxed italic text-sm">
              <p>
                // Every day, new creators are using simple systems to grow
                fast. The difference is not talent — it's having a clear
                process.
              </p>
              <p>
                // You can keep guessing what works… or follow a system that
          ...
          <div className="relative">
            <div className="bg-[#111111] border border-zinc-900 p-8 md:p-12 space-y-10 relative overflow-hidden active-glow">
              <div className="absolute top-0 right-0 p-4 font-mono text-[8px] text-zinc-800 font-black uppercase tracking-widest">
                Special_Offer
              </div>
              ...
              <div className="space-y-4 pt-6 border-t border-zinc-900/50">
                ...
                <p className="text-zinc-600 text-[10px] font-mono leading-relaxed font-bold italic uppercase tracking-wider text-left">
                  The market for faceless content is accelerating. Delay results
                  in permanent loss of market share. This system is designed for
                  immediate capture.
                </p>
              </div>
            ...
            <div className="mt-4 flex justify-between items-center px-2">
              <span className="text-[7px] font-mono text-zinc-800 uppercase tracking-[0.5em] font-black italic">
                Ref: YT_MARKET_LOG_2026
              </span>
      ...
      <div className="max-w-[1000px] mx-auto px-4 md:px-10 relative z-10 space-y-6 md:space-y-10">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-zinc-500 max-w-2xl mx-auto font-mono font-bold leading-relaxed italic uppercase tracking-tight">
            // Get access to the full system and start creating your first
            videos today.
          </p>
        </div>
      ...
      <div className="max-w-[1000px] mx-auto px-4 md:px-10">
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            <div
              key={i}
              className="bg-[#111111] border border-zinc-900 p-8 space-y-4 hover:border-amber/20 transition-all"
            >
    ...
    <section className="py-10 md:py-24 border-b border-zinc-900 bg-[#080808] relative overflow-hidden text-left">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-16">
          ...
          <p className="max-w-sm text-[11px] font-mono font-bold uppercase tracking-widest leading-relaxed italic text-zinc-600">
            // These specialized modules are included for free when you enroll
            in the full system today.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {bonuses.map((bonus, i) => {
            ...
            return (
              <div
                key={i}
                className="group relative bg-[#111111] border border-zinc-900 p-10 space-y-6 overflow-hidden active-glow hover:border-amber/40 transition-all duration-700"
              >
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-[9px] font-mono font-black text-zinc-700 uppercase tracking-[0.4em]">
                    {bonus.label}
                  </span>
                </div>
...
export const Landing = () => {
  ...
  const handleAction = async () => {
    console.log("RAZORPAY_REWRITE: Starting fresh checkout sequence...");

    if (!user) {
      console.log("RAZORPAY_REWRITE: No user session. Redirecting to signup.");
      navigate("/signup");
      return;
    }
    ...
    if (user.has_access) {
      console.log(
        "RAZORPAY_REWRITE: User already has access. Redirecting to dashboard.",
      );
      navigate("/dashboard");
      return;
    }
    ...
    try {
      // 1. Create Order
      console.log("RAZORPAY: Calling create-order...");
      ...
      const order = orderText ? JSON.parse(orderText) : {};

      if (!orderRes.ok) {
        throw new Error(order.message || "Order creation failed");
      }

      console.log("RAZORPAY: Order generated:", order.id);

      const razorpayKey = (import.meta.env.VITE_RAZORPAY_KEY_ID || "").trim();
      if (!razorpayKey) {
        throw new Error("Razorpay key missing in .env");
      }
      ...
      const options = {
        ...
        name: "100Kpro",
        description: "Enrollment in Viral Shorts Mastery",
        order_id: order.id, // ✅ FIXED (was order.order_id ❌)
        ...
        handler: async (response) => {
          ...
          try {
            ...
            const verifyResult = verifyText ? JSON.parse(verifyText) : {};
            ...
            window.alert(`Payment Verification Failed: ${err.message}`);
          } finally {
            setLoading(false);
          }
        },
      ...
      rzp.on("payment.failed", (response) => {
        ...
        if (response.error.reason === "payment_risk_check_failed") {
          msg = "Use Razorpay test card (4111...) in test mode, not real card.";
        }
      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-16 py-6 md:py-16 grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-32 items-center border-b border-zinc-900 text-left">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-zinc-600 max-w-lg font-mono font-bold leading-relaxed italic">
            // FOLLOW A STEP-BY-STEP METHOD TO TURN IDEAS INTO HIGH-PERFORMING
            VIDEOS. NO COMPLEX EDITING. NO GUESSWORK.
          </p>
        ...
        >
          <div className="bg-[#0A0A0A] border border-zinc-900 shadow-[0_50px_100px_-20px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            <div className="h-10 bg-[#111111] flex items-center justify-between px-4 border-b border-zinc-900">
              ...
              <span className="text-[8px] font-mono font-black uppercase tracking-[0.5em] text-zinc-600 italic text-right">
                SECURE_DASHBOARD_V2.0
              </span>
            </div>
            ...
            <div className="p-8 space-y-8 bg-[#111111] text-left">
              ...
              <div className="space-y-3">
                {LESSONS.slice(3, 6).map((lesson, idx) => (
                  <div
                    key={lesson.id}
                    className={`flex items-center gap-4 p-3 border border-zinc-900 bg-black/50 ${idx > 0 ? "opacity-20" : ""}`}
                  >
                    <span className="text-[9px] font-black font-mono text-zinc-700 italic">
