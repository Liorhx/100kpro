  ...
  return (
    <div className="h-screen bg-[#0A0A0A] text-white flex flex-col overflow-hidden font-sans">
      ...
      <nav className="h-20 border-b border-zinc-900/50 flex items-center justify-between px-5 md:px-12 bg-[#0A0A0A]/95 backdrop-blur-md sticky top-0 z-50 shrink-0">
        ...
        <div className="flex items-center gap-4 md:gap-10">
          <div className="hidden xs:flex flex-col items-end">
            <span className="text-[8px] uppercase tracking-[0.4em] text-amber font-black italic">
              Member_Online
            </span>
            <span className="text-[9px] text-zinc-600 font-mono font-bold uppercase truncate max-w-[120px] md:max-w-none">
              {user.email}
            </span>
          </div>
          <button
      ...
      <div className="flex-1 flex overflow-hidden h-[calc(100vh-80px)]">
        {/* Sidebar */}
        <aside className="w-80 border-r border-zinc-900 flex flex-col bg-[#0A0A0A] shrink-0 lg:flex  h-full overflow-hidden">
          <div className="p-8 border-b border-zinc-900 text-left">
            ...
            <div className="space-y-4">
              <div className="flex items-end justify-between">
                <span className="text-[9px] text-zinc-600 font-mono font-black uppercase tracking-[0.2em]">
                  Learning Progress
                </span>
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar bg-[#0A0A0A] min-h-0">
            {lessons.map((lesson, idx) => (
              ...
              >
                ...
                <div
                  className={`w-8 h-8 shrink-0 flex items-center justify-center text-[10px] font-black font-mono transition-all border ${
                    idx === activeLessonIdx
                ...
                <div className="flex-1 space-y-1">
                  <p
                    className={`text-[10px] font-black uppercase tracking-tight leading-tight transition-colors ${
                      idx === activeLessonIdx
                        ? "text-amber"
                  ...
                  <div className="flex items-center gap-2 opacity-30 group-hover:opacity-50 transition-opacity">
                    <Activity
                      size={10}
                      className={
                        idx === activeLessonIdx ? "text-amber" : "text-zinc-700"
                      }
                    />
                    <span className="text-[9px] font-black font-mono text-zinc-600">
                      {lesson.duration}
                    </span>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 items-start text-left">
              <div className="lg:col-span-2 space-y-8">
                <div className="space-y-6">
                  <div className="flex items-center gap-6">
                    <div className="px-3 py-1.5 border border-zinc-800 bg-[#111111] flex items-center">
                      <span className="text-[10px] font-black uppercase tracking-[0.4em] text-amber">
                        Module{" "}
                        {String(Math.floor(activeLessonIdx / 3) + 1).padStart(
                          2,
                          "0",
                        )}
                      </span>
                    </div>
                    <span className="text-[10px] font-black uppercase tracking-[0.5em] text-zinc-700 font-mono">
                      Lesson #{String(activeLessonIdx + 1).padStart(3, "0")}
                    </span>
                  </div>
                ...
                <div className="p-10 bg-[#111111] border border-zinc-900 relative overflow-hidden">
                  ...
                  <h4 className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-600 mb-6 flex items-center gap-3">
                    <ShieldCheck size={12} className="text-amber" /> Lesson
                    Details
                  </h4>
              ...
              <div className="space-y-8">
                <div className="bg-[#111111] border border-zinc-900 p-8 space-y-10">
                  <div className="space-y-6">
                    <p className="text-[10px] font-black uppercase text-zinc-700 tracking-[0.5em] italic font-mono text-center">
                      Study Stats
                    </p>
                    <div className="space-y-8 pt-2">
                      <div className="space-y-3">
                        ...
                        <div className="h-[2px] bg-zinc-900 w-full">
                          <div className="h-full bg-amber w-full active-glow"></div>
                        </div>
                      </div>
                      <div className="space-y-3">
                        <div className="flex justify-between text-[10px] font-mono font-black uppercase tracking-widest">
